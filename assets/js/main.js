(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(window).on('scroll', function () {
            if ( ($(window).width() >= 320) && ($(this).scrollTop() > 300)) {
        ...
        var fixed_social_links = $("#social-links ")

        $(window).on('scroll', function () {
            if ($(this).scrollTop() > 300){
                fixed_social_links.css("display", "block");
            } else {
                fixed_social_links.css("display", "none");
            }
        });
        ...
        var swiper = new Swiper(".schedule", {
            slidesPerView: 4,
            spaceBetween: 5,
            slidesPerGroup: 1,
            loop: true,
